...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/info/toronto-weed-dispensary", destination: "/weed-dispensary-toronto", permanent: true },
      { source: "/info/dispensary-near-me-toronto", destination: "/weed-dispensary-toronto", permanent: true },
      { source: "/info/weed-store-near-toronto", destination: "/weed-dispensary-toronto", permanent: true },
