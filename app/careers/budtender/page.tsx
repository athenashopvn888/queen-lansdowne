...
export const metadata: Metadata = {
  title: { absolute: "Budtender Or Manager Application | Queen Lansdowne Cannabis" },
  description:
    "Apply for budtender or manager opportunities at Queen Lansdowne Cannabis in Toronto. Submit availability, retail experience, motivation, determination, and customer-service answers.",
  alternates: {
    canonical: "https://www.queenlansdownecannabis.ca/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with QLC.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>QLC Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Queen Lansdowne Cannabis is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Late-shift availability is a plus at QLC</li>
            </ul>
          </div>
        </div>
      </section>
