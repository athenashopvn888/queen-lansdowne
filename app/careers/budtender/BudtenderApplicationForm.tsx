...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at QLC" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="QLC01" />
      <input type="hidden" name="StoreName" value="Queen Lansdowne Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>What interests you about cannabis retail or learning the QLC menu?</span>
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Queen Lansdowne Cannabis?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Queen and Lansdowne for scheduled shifts?</legend>
