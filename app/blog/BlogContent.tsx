...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Queen Lansdowne Cannabis is Toronto's Best Dispensary",
  ...
  },
  {
    ...
    excerpt: "Age limits, public consumption rules, possession limits, and where you in Toronto. Stay informed.",
    date: "2026-04-25",
    category: "News",
    emoji: "⚖️",
    readTime: "4 min",
