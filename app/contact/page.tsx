...
export const metadata: Metadata = {
  ...
  description:
    "Visit Queen Lansdowne Cannabis at 1472 Queen St W, Toronto, ON M6K 1M3. Open 24 hours, 7 days a week. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "1472 Queen St W, Toronto. Open 24 hours, 7 days a week. Premium cannabis, always fire.",
  },
};
