  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(
        `https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=QLC01`,
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Queen Lansdowne Cannabis is launching delivery across Toronto.
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            Can&apos;t wait? Visit us in-store at <strong>1472 Queen St W, Toronto</strong> —
            we are <strong>Open Daily: 10:00 AM - 03:00 AM</strong>. Call <strong>(647) 553-1472</strong>.
          </p>
        </div>
      </div>
      <Footer />
