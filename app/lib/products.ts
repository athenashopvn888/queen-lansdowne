...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Queen Lansdowne Cannabis?", a: "Yes! Visit us at 1472 Queen St W, Toronto. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Queen Lansdowne Cannabis, Toronto. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Queen Lansdowne Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 1472 Queen St W, Toronto.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at Queen Lansdowne Cannabis, Toronto. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "Queen Lansdowne Cannabis offers a premium selection of cannabis concentrates in Toronto. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 1472 Queen St W.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoIntro: "Discount native cigarettes at Queen Lansdowne Cannabis, Toronto. Premium and value brands at the best prices on Toronto St.",
    seoDescription: "Queen Lansdowne Cannabis is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1472 Queen St W in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Queen Lansdowne Cannabis, Toronto.",
    seoDescription: "Queen Lansdowne Cannabis carries a curated selection of magic mushrooms and specialty products in Toronto. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 1472 Queen St W for our full selection.",
    faqs: [
