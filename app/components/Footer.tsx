        ...
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            ...
            <nav className={styles.links}>
              <Link href="/">Home</Link>
              <Link href="/exotic-weed">Exotic Weed Flower</Link>
              <Link href="/premium-weed">Premium Weed Flower</Link>
              <Link href="/aaa-weed">AAA+ Weed Flower</Link>
              <Link href="/aa-weed">AA Weed Flower</Link>
              ...
              <Link href="/weed-dispensary-toronto">Weed Store Near Toronto</Link>
