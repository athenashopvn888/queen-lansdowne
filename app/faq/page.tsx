...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about Queen Lansdowne Cannabis in Toronto. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Queen Lansdowne Cannabis located?", a: "We are located at 1472 Queen St W, Toronto, ON M6K 1M3. We're easily accessible by TTC bus routes and close to major highways like the 401." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Queen Lansdowne Cannabis is walk-in only. Just show up anytime — we're open Open 24 Hours." },
