"""
Queen Lansdowne Cannabis — Product Update Script
===================================
Drop your ONHAND CSV into the queen-lansdowne folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Queen Lansdowne Cannabis — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://queenlansdownecannabis.ca")
    else:
